						...
						<div class="well row pt-2x pb-3x bk-light">
							<div class="col-md-8 col-md-offset-2">
								...
								<form action="" class="mt" method="post">
									...
									<input type="text" id="adminUserName" placeholder="Username" name="username" class="form-control mb">
									<label for="" class="text-uppercase text-sm">Password</label>
									<input type="password" id="adminPassword" placeholder="Password" name="password" class="form-control mb">
									

									<input type="submit" name="login" id="adminLogin" class="btn btn-primary btn-block" value="login" >
								</form>
							</div>
						</div>
					</div>
